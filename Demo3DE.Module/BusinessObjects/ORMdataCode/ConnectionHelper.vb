...
Namespace Demo3
    Public Class ConnectionHelper
        Shared persistentTypes As Type() = New Type() {
            GetType(DonNhapHangs),
            GetType(ChiTietDonNhapHang),
            GetType(SanPhams)
        }
        ...
        Public Shared ReadOnly Property ConnectionString() As String
            Get
                Return System.Configuration.ConfigurationManager.ConnectionStrings("(localdb)MSSQLLocalDBDemo3").ConnectionString
            End Get
        End Property
